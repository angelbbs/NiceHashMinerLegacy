...
// Type: MSI.Afterburner.ControlMemoryGpuEntry
  ...
  public class ControlMemoryGpuEntry : ISerializable, IXmlSerializable
  {
    ...
    public void ResetToDefaults()
    {
      try
      {
        ...
        this.macmGpuEntry.auxVoltageCur = this.AuxVoltageDef;
        ...
        this.macmGpuEntry.auxVoltageBoostCur = this.AuxVoltageBoostDef;
