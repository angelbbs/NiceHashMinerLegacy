        ...
        private static readonly List<MinerOptionPackage> Defaults = new List<MinerOptionPackage>
        {
            new MinerOptionPackage(
                ...
                new List<MinerOption>() {
                    ...
                    new MinerOption("nbminer_log-cycle", "--lrv", "--lhr-reduce-value", "", MinerOptionFlagType.SingleParam),
                    new MinerOption("nbminer_log-cycle", "--lrt", "--lhr-reduce-time", "", MinerOptionFlagType.SingleParam),
                    new MinerOption("nbminer_log-cycle", "--lrl", "--lhr-reduce-limit", "", MinerOptionFlagType.SingleParam),
