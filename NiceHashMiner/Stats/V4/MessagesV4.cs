...
namespace NiceHashMiner.Stats.V4
{
    ...
    public class NhmwsAction
    {
        ...
        public List<ParameterLogin> Parameters { get; set; } = new List<ParameterLogin>();
        [JsonIgnore]
    ...
    {
        [JsonProperty("devices")]
        public List<MinerAlgoSpeed> Miners { get; set; } = new List<MinerAlgoSpeed>();
    }
    ...
    public class SchedulesWS4
    {
        ...
        public bool enabled { get; set; }
        [JsonProperty("slots")]
        public List<List<object>> slots = new List<List<object>>();
    }
